...
from login import *  # Replace 'your_login_module' with the actual name of the module containing your login function
...
def test_failed_login_and_register_successfully(user_inputs, login_open_users_file_stub, capsys):
    ...
    # Check that the file was opened and written to with the expected content
    new_user = {"username": "non_existing_user", "password": "Correct_New_Password", "wallet": 0}
